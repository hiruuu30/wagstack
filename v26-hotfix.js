(() => {
  ...
  const css=`
  /* v26: Updates is one swipeable bento, never a card inside a card */
  ...
  /* v26: Health card copy stays short so the marquee has its own lane */
  ...
  /* v26: Health picker must be usable above the workspace clipping */
  ...
  /* v26: restore a clean local sun/moon morph */
  ...
  function patchHealthModal(){
    ...
    const id=form.querySelector('input[name="id"]')?.value; let current='Other';
  ...
  function patch(){themeIcon();patchUpdates();patchHealthHome();patchPicker();patchHealthModal();}
